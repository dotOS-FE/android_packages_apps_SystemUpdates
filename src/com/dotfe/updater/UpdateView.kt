...
import com.dotfe.updater.changelog.ChangelogAdapter
import com.dotfe.updater.controller.UpdaterController
import com.dotfe.updater.controller.UpdaterService
import com.dotfe.updater.misc.*
import com.dotfe.updater.model.ChangelogItem
import com.dotfe.updater.model.UpdateInfo
import com.dotfe.updater.model.UpdateStatus
import com.dotfe.updater.ui.ChangelogSheet
...
class UpdateView : LinearLayout {
    ...
    fun lateInit() {
        ...
        val currentVersion = SystemProperties.get(Constants.PROP_DOTFE_VERSION)
