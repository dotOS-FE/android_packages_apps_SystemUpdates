 ...
 */
package com.dotfe.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.dotfe.version";
    public static final String PROP_DOTFE_VERSION = "ro.modversion";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.dotfe.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.dotfe.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "dotfe.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "dotfe.updater.uri";
    public static final String PROP_UPDATER_GAPPS_URI = "dotfe.updater.gapps.uri";
    ...
    public static final String DOWNLOAD_URL = "https://sourceforge.net/projects/dotos-fe/files/dot11/${device}/${type}/${file_name}/download";
